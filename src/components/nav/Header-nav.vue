            ...
            <div v-if="!innerWidth || mobileNav" class="nav-select">
                ...
                <div class="nav-lang">
                    ...
                    <ul v-if="isSet">
                        ...
                        <li @click="setLang('en')"><img src="../../assets/EN.png" alt=""/><span>English</span></li>
                    </ul>
                </div>
            </div>
            <span class="nav-login" @click="login">scatter登录</span>
...
<script>
  ...
  export default {
    ...
    computed: mapState(['scatter', 'identity', 'network']),
    methods: {
      isSetLang() {
      ...
      login() {
        ...
        if (this.identity !== null) {
          ...
          this.$store.dispatch('LOGIN').then(res => this.$message.success('恭喜你，这是一条成功消息')).catch(err => {
            console.log(err)
          })
        }
      }
